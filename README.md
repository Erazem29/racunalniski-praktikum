...
+ ctrl+o ctrl+k odpre raziskovalnik
+ ctrl+a pa označi celotno besedilo
+ ctrl+alt+del ti da možnost za dostop do task managerja
+ ctrl+alt+(puščica gor ali dol) ti da možnost multi cursorja
+ ctrl+z je undo
<!-- 2. nivojski razdelek -->
## Izvorna koda
