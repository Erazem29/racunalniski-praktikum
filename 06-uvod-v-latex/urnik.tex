...
kršitev omejitve \(n, z, u_n\), z pa njeno utež. Z naslednjo formulo izračunamo
kakovost urnika:
...
zato si je smiselno podrobneje ogledati posamezne korake.
   ...
   Z zanko se sprehodimo po vektorju vseh predmetov. Predmet na \emph{i}-tem koraku
   označimo s\(predmet_i\).

   Naslednja vgnezdena zanka nas popelje po vseh predavalnicah. Predavalnico na
   \emph{j}-tem koraku označimo s \(predavalnica_j\).
