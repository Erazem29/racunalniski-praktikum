...
\begin{equation}
   \label{eq:mc}
   \mathcal{M}_2 (n; A,D) = \frac{1}{2}n (2A+D(N_2-1))
\end{equation}
...
R. Schroeppel leta 1973  \cite{gardner}(glej Gardner ).
Natančno število vseh različnih normalnih magičnih kvadratov reda 6 ni znano.
Avtorja navedenega približka sta Pinn in Wieczerkowski \cite{pinn} (glej), ki
